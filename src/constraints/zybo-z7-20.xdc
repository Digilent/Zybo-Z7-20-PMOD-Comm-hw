...
set_property -dict { PACKAGE_PIN U7    IOSTANDARD LVCMOS33     } [get_ports { iic_rtl_0_scl_io }]; #IO_L11P_T1_SRCC_13 Sch=jb_p[2]        
set_property -dict { PACKAGE_PIN V7    IOSTANDARD LVCMOS33     } [get_ports { iic_rtl_0_sda_io }]; #IO_L11N_T1_SRCC_13 Sch=jb_n[2]       
